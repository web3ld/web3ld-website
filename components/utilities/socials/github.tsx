// components/utilities/socials/github.tsx
"use client";
...
/**
 * GitHub icon link to https://github.com/web3ld
 * - client component so it can be interactive/animated
 * - default size 200px (keeps aspect via viewBox)
 */
export default function Github({
  size = 200,
  className = "",
  title = "web3ld on GitHub",
}: Props) {
  return (
    <a
