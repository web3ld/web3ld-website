// app/home/resources/SchemaDocsCard.tsx
import React from 'react';
import styles from './SchemaDocsCard.module.css';

export function SchemaDocsCard() {
  return (
    <a
      ...
      aria-label="Open Schema.org documentation in a new tab"
    >
      {/* decorative background icon (centered, absolute) - user-supplied SVG */}
      <svg
      ...
      <div className={styles.content}>
        ...
        <p className={styles.body}>
          Read the documentation to learn how to apply it, or ask AI.
        </p>
      </div>
    </a>
  );
