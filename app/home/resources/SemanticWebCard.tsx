// app/home/resources/SemanticWebCard.tsx
"use client";

import React from "react";
import styles from "./SemanticWebCard.module.css";

export function SemanticWebCard() {
  return (
    <a
      className={styles.link}
      href="https://en.m.wikipedia.org/wiki/Semantic_Web"
      target="_blank"
      rel="noreferrer"
      referrerPolicy="no-referrer"
      aria-label="Open Wikipedia Semantic Web article in a new tab"
    >
      <h3 className={styles.title}>All About the Semantic Web</h3>
      ...
      <div className={styles.svgWrapper} aria-hidden="true">
        <svg
          ...
          role="img"
        >
          <title>semantic web emblem</title>
          <path
            fill="currentColor"
            fillRule="evenodd"
            strokeMiterlimit={10}
      ...
      <div className={styles.content}>
        <p className={styles.body}>Let Wikipedia fill you in on the movement and concepts</p>
      </div>
    </a>
  );
}
